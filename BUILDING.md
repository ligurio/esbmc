...
## Preparing the Lua frontend (optional)

The Lua frontend enables the analysis of Lua code, leveraging the
AST (Abstract Syntax Tree) generated by `ast2json` Lua module.

To use the Lua frontend, follow these steps:
